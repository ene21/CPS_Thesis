...
function main()
    ...
    if a.Port>0
        ...
        [EffMotor,error] = runMotor(a,Xetemp,motorPin,fspeed,accumError,avgtemp);
        fspeed = EffMotor;
...
function [EffMotor,error] = runMotor(a,temp,pin,fspeed,accumError,avgtemp)
    maxVolt = 5;
    setpoint = 23;
    Kp = 1;
    Ki = 0.1;
    ...
    PID = Kp*error + Ki*accumError % + Kd *(avgtemp-temp)
